...
void ArtistBrowser_browse_complete(sp_artistbrowse *browse, Callback *st)
{
...
static PyObject *ArtistBrowser_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
...
static void ArtistBrowser_dealloc(PyObject *arg)
{
#ifdef DEBUG
...
static PyObject *ArtistBrowser_is_loaded(ArtistBrowser *self ) {
    return Py_BuildValue("i", sp_artistbrowse_is_loaded(self->_browser));
}

Py_ssize_t ArtistBrowser_sq_length(ArtistBrowser *self) {
    return sp_artistbrowse_num_albums(self->_browser);
}

PyObject *ArtistBrowser_sq_item(ArtistBrowser *self, Py_ssize_t index) {
...
void artistbrowser_init(PyObject *m) {
